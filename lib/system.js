...
class System extends EventEmitter {
    ...
    constructor (kodiConnection) {
        ...
        this._kodiConnection.notification('GUI.OnScreensaverDeactivated', () => { system._onSreensaverOn() })
        this._kodiConnection.notification('GUI.OnScreensaverActivated', () => { system._onSreensaverOff() })
    ...
    _onSreensaverOn () {
        Homey.app.log('System._onSreensaverOn()')
        this.emit('screensaverOn')
    }

    _onSreensaverOff () {
            Homey.app.log('System._onSreensaverOff()')
            this.emit('screensaverOff')
        }
}
